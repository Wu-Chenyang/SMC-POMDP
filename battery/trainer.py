        ...
        for epoch_idx in range(training_epochs):
            for batch_idx, batched_data in enumerate(chain(*data_loaders)):
                ...
                if step % test_interval == 0:
                    ...
                    states, observations = model.sample_from_prior(2, 2000, data.actions.swapaxes(0, 1).expand((-1, 2, -1)))
                    future_capacity = observations[:, :, -1].cpu()
